    ...
    try {
      ...
      if (!displayVersion) {
        await settingsApi.openExternal(
          "https://github.com/blackbladestudio/cc-switch/releases",
        );
        return;
      }

      await settingsApi.openExternal(
        `https://github.com/blackbladestudio/cc-switch/releases/tag/${displayVersion}`,
      );
    } catch (error) {
            ...
            <Button
              ...
              onClick={() =>
                settingsApi.openExternal(
                  "https://github.com/blackbladestudio/cc-switch",
                )
              }
              className="h-8 gap-1.5 text-xs"
            >
